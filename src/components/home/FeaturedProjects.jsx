                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
                    {PROJECTS_DATA.map((project, index) => {
                            ...
                            return (
                                ...
                                >
                                    <div className={`flex flex-col lg:w-full justify-between gap-6 ${isSecondCard ? 'lg:flex-row-reverse' : 'lg:flex-row'}`}>
                                        {/* Image Container */}
                                        <div className="relative w-full lg:w-[60%] aspect-4/2.5 sm:aspect-4/1.5 md:aspect-4/2.5 lg:aspect-4/2 rounded-b-lg overflow-hidden flex items-center justify-center shrink-0">
                        ...
                        return (
                            ...
                            >
                                <div className="relative w-full aspect-4/2.5 sm:aspect-4/1.5 md:aspect-4/2.5 rounded-b-lg overflow-hidden mb-6 flex items-center justify-center shrink-0">
                                    <ProjectPreview 
                                        image={project.image} 
                                        alt={project.title} 
                                        priority={false} 
