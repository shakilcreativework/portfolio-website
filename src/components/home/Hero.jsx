                        ...
                        <div className="grid items-center gap-20 lg:grid-cols-2">
                            ...
                            <div className="relative flex items-center justify-center">
                                ...
                                <div className="relative max-w-xs sm:max-w-md rounded-3xl border border-border bg-card p-6 sm:p-8 backdrop-blur-xl shadow-xs">
                                    ...
                                    {/* Floating Badges */}
                                    <div className="absolute flex items-center gap-2 -left-3.5 sm:-left-8 top-22.5 rounded-xl text-foreground border border-border bg-background px-4 py-2 text-sm backdrop-blur-xl">
                                        <SiReact className="text-purple-600" /> React
                                    </div>

                                    <div className="absolute flex items-center gap-2 -right-3.5 sm:-right-8 -top-4 sm:top-10 rounded-xl text-foreground border border-border bg-background px-4 py-2 text-sm backdrop-blur-xl">
                                        <SiNextdotjs /> Next.js
                                    </div>
                                    ...
                                    <div className="absolute flex items-center gap-2 bottom-28 sm:bottom-10 -right-3.5 sm:-right-10 rounded-xl text-foreground border border-border bg-background px-4 py-2 text-sm backdrop-blur-xl">
