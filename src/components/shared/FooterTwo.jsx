            ...
            <Container>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
                    ...
                    <div className="space-y-3 sm:col-span-2">
                        <Logo />
                        <h3 className="text-purple-600">Creative Frontend Developer</h3>
                        <span className="text-muted">Currently building scalable web applications and crafting modern digital experiences while growing as a full-stack developer.</span>
                    </div>
                    {/* nav links */}
                    <div className="space-y-3">
                        <h3 className="text-foreground text-lg font-medium">Quick Links</h3>
                    ...
                    {/* social links */}
                    <div className="space-y-3">
                        <h3 className="text-foreground text-lg font-medium">Social links</h3>
                        <div className="flex flex-col gap-3 mt-5">
                            <Link href={'/'} className="hover:text-purple-600 transition flex gap-3 items-center">
                                <div className="w-6 h-6 bg-background flex justify-center items-center shadow-xs">
                            ...
                            <Link href={'/'} className="hover:text-purple-600 transition flex gap-3 items-center">
                                <div className="w-6 h-6 bg-background flex justify-center items-center shadow-xs">
                                    <MdOutlineMarkEmailUnread className="text-base" />
                                </div>
                                Email
                            </Link>
                        </div>
